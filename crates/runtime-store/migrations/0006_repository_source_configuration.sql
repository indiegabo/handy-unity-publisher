CREATE TABLE IF NOT EXISTS app_settings (
    ...
    managed_repositories_root TEXT,
    workspace_root TEXT,
    artifacts_root TEXT,
    logs_root TEXT,
...
CREATE TABLE repositories_v2 (
    ...
    logs_root_override TEXT,
    managed_repositories_root_override TEXT,
...
INSERT INTO repositories_v2 (
    ...
    logs_root_override,
    managed_repositories_root_override,
